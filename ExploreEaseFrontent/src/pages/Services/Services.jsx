...
import image from '../../assets/Explore-the-world/h5-tour-f-img-1.jpg'
...
const Services = () => {
    return (
        <div>
            <Navbabr />
            <div>
                <div className={`px-4 py-20 md:px-10 max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 justify-center items-center`}>
